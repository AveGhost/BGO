...
const FormFile = ({icon, event, handleDragOver, handleDrop, id, name, children, classes}: FormFileProps) => {
    return (
        <div className="relative w-full px-4 border-1 border-zinc-600 rounded-lg min-h-[650px] flex flex-col justify-center items-center">
