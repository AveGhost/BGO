        ...
        <div className="form w-full max-w-[450px] min-h-[550px] p-4">
            <div className="flex flex-col gap-4 justify-center items-center h-full">
                ...
                <FormWrapper onSubmit={formSubmit} isDataValid={isDataValid}>
                    <FromInput icon="majesticons:user-line" type="text" placeholder="Imie" name="first_name" value={formData.first_name} event={handleInputChange} />
                    <FromInput icon="majesticons:user-line" type="text" placeholder="Nazwisko" name="last_name" value={formData.last_name} event={handleInputChange}/>
                    <FromInput icon="majesticons:user-line" type="text" placeholder="Nazwa użytkownika" name="username" value={formData.username} event={handleInputChange}/>
                    <FromInput icon="carbon:email" type="email" placeholder="Adres e-mail" name="email" value={formData.email} event={handleInputChange}/>
                    ...
                    <FromInput icon="carbon:password" type="password" placeholder="Powtórz hasło" name="password2" value={formData.password2} event={handleInputChange}/>
