...
const FormSelect = ({isOpen,onClick,icon,title,elements,choosePlatform,chooseCategory}: FormSelectProps) => {
    return (
        <div className="w-full relative py-2 px-4 border-1 border-zinc-600 rounded-lg text-zinc-400">
            ...
            <FormSelectWrapper isOpen={isOpen} elements={elements} choosePlatform={choosePlatform} chooseCategory={chooseCategory} />
        </div>
    )
}
