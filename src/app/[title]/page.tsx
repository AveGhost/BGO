    ...
    return (
        <section className="py-6 container grid grid-cols-[180px_1fr] mx-auto">
            ...
            <div className="col-2 max-w-[800px]">
                ...
                <h2 className="text-2xl mb-4 mt-12 pb-4 font-medium border-b-1 border-zinc-600">Szok: Japonia wcale nie jest tak świetnym miejscem akcji dla Assassin’s Creed, jak się nam wszystkim wydawało.</h2>
