...
import FormFile from "@/components/form/form-file/form-file.component"
import FormTextArea from "@/components/form/form-textarea.component"
import PreviewImage from "@/components/other/preview-image.component"
import PostFieldWrapper from "@/components/add-post/add-post-field-wrapper.component"
import { Field } from "@/types/PostField"
import AddFieldButtons from "@/components/add-post/add-field-buttons"
import SetSummaryCardWrapper from "@/components/add-post/set-summary-card-wrapper.component"
import RatingTableElement from "@/components/review/rating-table-element.component"
...
import FormSearchSelect from "@/components/form/form-search/form-search-select.component"
    ...
    return (
        <div className="container max-w-[1200px] mx-auto py-6">
            <FormWrapper onSubmit={handleFormSubmit}>
                ...
                <FormButton type="submit" text="Zapisz i opublikuj" />
            </FormWrapper>
        </div>
    )
}
